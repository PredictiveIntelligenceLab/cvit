...
from utils import create_optimizer, create_train_state, create_checkpoint_manager, rollout
...
def evaluate(config):
    ...
    # One-step
    test_inputs, test_outputs = prepare_swe_dataset(directory=config.dataset.path,
